...
class VariablesExtensions:
    ...
    @staticmethod
    def print_nominal_counts(dataFrame: pd.DataFrame, indexes: list):
        for index in indexes:
            print(dataFrame[index].value_counts())

    @staticmethod
    def get_regression_command_string(dataFrame: pd.DataFrame, target_index: str, columns_to_remove: Optional[list] = []) -> str:
